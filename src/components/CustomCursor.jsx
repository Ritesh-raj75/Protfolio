...
const CustomCursor = () => {
    ...
    useEffect(() => {
        ...
        gsap.set([cursor, cursorBorder], {
            ...
            //variable for cursor position with different speeds
  ...
  return (
    ...
    <div
       ref={cursorBorderRef}
       className="fixed top-0 left-0 w-[40px] h-[40px] border rounded-full border-white pointer-events-none z-[998] mix-blend- difference opacity-50"
    />
    </>
  )
}
