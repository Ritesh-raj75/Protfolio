      ...
      >
        ...
        >
          ...
          <p className="text-black lg:w-[40rem] w-[20rem] absolute sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068] ">
            ...
            interfaces using React, Tailwind CSS, and advanced UI animations
            techniques. Focused on clean code, and pixel-perfect designs that
            stand out.
          </p>

          <button
            className="px-10 py-2 transition-all duration-500 bg-purple-400 rounded-xl hover:bg-white hover:text-black scale-[0.1] absolute sm:mt-[35px] mt-[30px] text-nowrap"
          ...
          <button
            ...
            className="px-10 py-2 transition-all duration-500 bg-purple-400 rounded-xl hover:bg-white hover:text-black scale-[0.1] absolute mt-[20px] sm:mt-[25px] text-nowrap"
          >
            Email Me
          </button>
          ...
          {showContact && (
            <div
              className="fixed flex flex-col items-center justify-center px-1 py-1 text-center text-black bg-white border border-purple-400 shadow-lg top-1/2 left-1/2 rounded-xl"
              style={{
            ...
            >
              <button
                ...
                className="text-purple-400 hover:text-pink-400 text-[2px] font-bold mb-1 self-end"
              >
                ✕
              </button>
              <span className="text-[2px] font-bold text-purple-600">
                Ritesh Raj
              </span>
              <span className="text-[2px] font-medium">
                Email:{" "}
                <span className="text-pink-500">rs8317594@gmail.com</span>
              </span>
              <span className="text-[2px] font-medium">
                Phone: <span className="text-purple-500">+91-7541881699</span>
              </span>
            </div>
          )}
        </div>
