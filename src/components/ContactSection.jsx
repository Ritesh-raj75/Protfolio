...
const ContactSection = () => {
  ...
  useEffect(()=>{
    ...
    //make sure all ScrollTriggers instances are properly killed
    const cleanup = () => {
  ...
  return (
   <section 
   ref={sectionRef}
   className="relative flex items-center justify-center bg-gradient-to-br from-purple-900 via-black to-gray-90" style={{overscrollBehavior: 'none'}}>
   ...
   >
    ...
    >
      ...
      <button className="px-10 py-2 transition-all duration-500 bg-black rounded-xl hover:bg-white hover:text-black scale-[0.1] absolute sm:mt-9 mt-7 text-nowrap" onClick={() => setShowContact(true)}>
        Contact Me
      </button>
      {showContact && (
  <div className="fixed flex flex-col items-center justify-center px-1 py-1 text-center text-black bg-white border border-purple-400 shadow-lg top-1/2 left-1/2 rounded-xl" style={{ transform: 'translate(-50%, -50%)', minWidth: '30px', minHeight: '30px', maxWidth: '40px', maxHeight: '40px' }}>
