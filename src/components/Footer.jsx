                ...
                {/* Scroll Links */}
                                <div>
                                        ...
                                        <div className="flex justify-center gap-6 md:gap-4 md:justify-start">
                                                <a
                                                    className='p-2 text-gray-300 transition-colors bg-gray-800 rounded-full hover:bg-violet-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-violet-400'
